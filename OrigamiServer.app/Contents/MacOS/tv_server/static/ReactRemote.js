...
const SVGRemote = props => {
  ...
  <svg width={375*3} height={653*3} viewBox="0 0 375 653">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(17.104 557.15)">
        <circle className = {""/*mute BG*/ } fill="#2C2D2E" cx={28.896} cy={28.851} r={28} />
        <path
          className = {""/*mute Icon*/}
  ...
  <circle className = {""/*cc BG*/} fill="#2C2D2E" cx={28.5} cy={28.846} r={28} />
        <path
          className = {""/*cc icon*/}
      ...
      <g transform="translate(17.918 477.572)">
        <circle className = {""/*back BG*/} fill="#2C2D2E" cx={28.082} cy={28.428} r={28} />
        <path
          className = {""/*back icon*/}   
      ...
      <g transform="translate(159.5 478)">
        <circle className = {""/*home BG*/} fill="#2C2D2E" cx={28} cy={28} r={28} />
        <path
          className = {""/*home icon*/}
      ...
      <g transform="translate(301 478)">
        <circle className = {""/*keybd BG*/} fill="#2C2D2E" cx={28} cy={28} r={28} />
        <path
      ...
      <g transform="translate(17.496 20.154)">
        <circle className = {""/*power bg*/} fill="#343437" cx={18.504} cy={18.846} r={18} />
        <path
      ...
      <g transform="translate(17.5 74.154)">
        ...
        <path
          ...
          mask="url(#prefix__d)"
        />
        <g className = {""/*left icon*/} mask="url(#prefix__d)" fill="#979797" fillRule="nonzero">
